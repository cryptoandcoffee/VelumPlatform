...
This document provides guidelines for internationalization of the Velum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `velum_en.ts` remains unchanged.
