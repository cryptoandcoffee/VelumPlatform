...
This mechanism has been integrated into Bitcore-Node-Velum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/velumcrypto/insight-api-velum#web-socket-api](https://github.com/velumcrypto/insight-api-velum#web-socket-api)
* API: [https://github.com/velumcrypto/insight-api-velum#instantsend-transactions](https://github.com/velumcrypto/insight-api-velum#instantsend-transactions)
...
By default, the Velum Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Velum Core daemon:
