...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Velum related functionality
...
/*
    ...
    allow endless transaction that would bloat Velum and make it unusable. To
