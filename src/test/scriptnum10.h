...
#ifndef VELUM_TEST_SCRIPTNUM10_H
#define VELUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Velum Core 0.10.0, for cross-comparison.
 */
public:
