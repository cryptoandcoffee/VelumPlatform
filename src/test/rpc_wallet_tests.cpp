...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CVelumAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CVelumAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CVelumAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CVelumAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CVelumAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CVelumAddress(arr[0].get_str()).Get() == demoAddress.Get());
