...
#define BOOST_TEST_MODULE Velum Test Suite

#include "test_velum.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_velum_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
