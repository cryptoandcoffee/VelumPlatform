 ...
 *
 *   // network
 *   CVelumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.velum.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CVelumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: VelumNetwork
// //   -- signature requirements : Key1(User)
// class CVelumNetworkVariable : public CGovernanceObject
// {
// private:
