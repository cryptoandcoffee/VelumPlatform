...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VelumNetwork") type = VelumNetwork;
    if(strType == "VelumNetworkVariable") type = VelumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VelumNetwork) s = "VelumNetwork";
    if(type == VelumNetworkVariable) s = "VelumNetworkVariable";
