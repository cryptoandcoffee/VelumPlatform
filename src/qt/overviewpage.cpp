...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(VelumUnits::VLM),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = VelumUnits::floorWithUnit(unit, amount, true, VelumUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, VelumUnits::separatorAlways));
    ui->labelUnconfirmed->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, VelumUnits::separatorAlways));
    ui->labelImmature->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, VelumUnits::separatorAlways));
    ui->labelAnonymized->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, VelumUnits::separatorAlways));
    ui->labelTotal->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, VelumUnits::separatorAlways));
    ui->labelWatchAvailable->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, VelumUnits::separatorAlways));
    ui->labelWatchPending->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, VelumUnits::separatorAlways));
    ui->labelWatchImmature->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, VelumUnits::separatorAlways));
    ui->labelWatchTotal->setText(VelumUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, VelumUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("VLM")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = VelumUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, VelumUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), VelumUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = VelumUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, VelumUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), VelumUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(VelumUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(VelumUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
