...
#ifndef VELUM_QT_VELUMUNITS_H
#define VELUM_QT_VELUMUNITS_H
...
/** Velum unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VelumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VelumUnits(QObject *parent);

    /** Velum units.
      @note Source: https://en.velum.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VLM,
...
typedef VelumUnits::Unit VelumUnit;

#endif // VELUM_QT_VELUMUNITS_H
