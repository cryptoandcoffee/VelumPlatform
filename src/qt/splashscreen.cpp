    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextVelum   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Velum developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace,copyrightTextVelum);
