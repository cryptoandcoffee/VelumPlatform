    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("VELUM-light"), QVariant("light"));
    ui->theme->addItem(QString("VELUM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("VELUM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("VELUM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("VELUM-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new VelumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->velumAtStartup, OptionsModel::StartAtStartup);
