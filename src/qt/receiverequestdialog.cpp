...
#include "config/velum-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatVelumURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + VelumUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatVelumURI(info));
}
