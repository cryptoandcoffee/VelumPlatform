 ...
 * for both velumd and velum-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Velum Core");
...
#ifdef GIT_ARCHIVE
#define GIT_COMMIT_ID "4f9186ec2"
#define GIT_COMMIT_DATE "Sat, 12 May 2018 15:02:33 -0500"
#endif
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/velum/bips/blob/master/bip-0014.mediawiki) 
 */
