...
//#define ENABLE_VELUM_DEBUG
#ifdef ENABLE_VELUM_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const VELUM_CONF_FILENAME;
extern const char * const VELUM_PID_FILENAME;
...
{
    std::string s = strprintf("velum-%s", name);
