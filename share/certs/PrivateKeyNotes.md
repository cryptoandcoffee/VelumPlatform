...
unlocked to sign the Velum-Qt.app bundle.
...
allowing somebody to distribute a Velum-Qt.app or velum-qt-setup.exe with a valid
...
that the velum-qt.exe file inside the installer had not been tampered with.
